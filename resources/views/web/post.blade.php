                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="{{ route('web.post', $item->slug) }}" title="">
                                                <img src="{{ $item->imageUrl() }}" alt="" class="img-fluid" width="200" height="150">
                                    ...
                                    @foreach ($post->comments as $comments)
                                        <div class="media">
                                            <div class="media-body">
                                                <h4 class="media-heading user_name"> {{ $comments->user->name }} <small>{{ \Carbon\Carbon::parse($comments->created_at)->format('d-m-Y')  }}</small></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="form-wrapper" method="post" action="{{ route('web.post.comment', $post->id)  }}">
                                        ...
                                        <textarea class="form-control mb-2" name="content" placeholder="Your comment"></textarea>
